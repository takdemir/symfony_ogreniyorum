...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'app.exception_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\ExceptionListener A AppBundle\EventListener\ExceptionListener instance.
     */
    protected function getApp_ExceptionListenerService()
    {
        return $this->services['app.exception_listener'] = new \AppBundle\EventListener\ExceptionListener($this->get('router'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.exception', array(0 => 'app.exception_listener', 1 => 'onKernelException'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'tez', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_27a23bc6e0af14cb1694feffd7a218733df71a2214c8b1e46b1efed2dca6a9b3');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/', NULL, array(), array(0 => '127.0.0.1', 1 => '::1'));
        ...
        $k->add($j, array(0 => 'ROLE_NO_ACCESS'), NULL);
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('tbm.akdemir@gmail.com');
        $a->setPassword('geceprensi');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('cd118675a8dd167c80a1e97532a11edc50b3bc22');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.our_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:Admin', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'tbm.akdemir@gmail.com',
            'mailer_password' => 'geceprensi',
            'secret' => 'cd118675a8dd167c80a1e97532a11edc50b3bc22',
            'locale' => 'en',
            ...
            'kernel.secret' => 'cd118675a8dd167c80a1e97532a11edc50b3bc22',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'tbm.akdemir@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'geceprensi',
